...
pub struct ExternalKey(
  ...
  pub BoundedVec<u8, ConstU32<{ ExternalKey::MAX_SIZE }>>,
);
#[cfg(feature = "scale")]
...
impl scale::MaxEncodedLen for ExternalKey {
  fn max_encoded_len() -> usize {
    crate::borsh_max_encoded_len_bounded_vec::<{ ExternalKey::MAX_SIZE }, u8>()
  }
}
...
impl ExternalKey {
  /// The maximum size for an external key.
  /*
...
fn external_key() {
  ...
  for i in 0 ..= ExternalKey::MAX_SIZE {
