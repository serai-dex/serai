...
pub mod pallet {
    ...
    pub fn add_liquidity(
      ...
      if reserve1.is_zero() || reserve2.is_zero() {
        ...
        if amount2_optimal <= amount2_desired {
          ensure!(amount2_optimal >= amount2_min, Error::<T>::AssetTwoDepositDidNotMeetMinimum);
          amount1 = amount1_desired;
          ...
          ensure!(amount1_optimal >= amount1_min, Error::<T>::AssetOneDepositDidNotMeetMinimum);
  ...
  impl<T: Config> Pallet<T> {
        ...
        for assets_pair in path.windows(2) {
          if let [asset1, asset2] = assets_pair {
            ...
            let to = if i < path_len - 2 {
              ...
              Self::get_pool_account(&Self::get_pool_id(asset2.clone(), asset3.clone()))
            } else {
              send_to.clone()
            };
    ...
    fn validate_minimal_amount(value: T::AssetBalance, asset: &T::MultiAssetId) -> Result<(), ()> {
