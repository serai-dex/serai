...
pub fn monero(orchestration_path: &Path, network: Network) {
  ...
  const MONERO_VERSION: &str = "0.18.5.1";
...
RUN wget https://raw.githubusercontent.com/monero-project/monero-site/76f3846db3442be40676fd2e5432dd809d44ea3f/downloads/hashes.txt -O SHA256SUMS
