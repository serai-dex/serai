...
pub fn btc_send_message() {
  ...
  println!("Sending BTC encrytped message");
  ...
  producer
    .send(BaseRecord::to("BTC_Topic").key(&format!("BTC_Processor")).payload(&enc))
...
pub fn eth_send_message() {
  ...
  println!("Sending ETH encrytped message");
  ...
  // Send Encrypted Messages to secure partitian
  producer
    .send(BaseRecord::to("ETH_Topic").key(&format!("ETH_Processor")).payload(&enc))
    .expect("failed to send message");
}
...
pub fn xmr_send_message() {
  ...
  println!("Sending XMR encrytped message");
  ...
  // Send Encrypted Messages to secure partitian
  producer
    .send(BaseRecord::to("XMR_Topic").key(&format!("XMR_Processor")).payload(&enc))
    .expect("failed to send message");
}
