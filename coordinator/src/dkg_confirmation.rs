        ...
        loop {
          ...
          match msg {
            ...
            messages::sign::CoordinatorMessage::Preprocesses {
              ...
              // Substrate performs the MuSig aggregation with `dalek_ff_group::Ristretto`
              ...
              /*
                Except we need it with `modular_frost::curve::Ristretto` to actually sign with
                these keys, so we map our keys exactly as-is across the two ciphersuites.
              */
