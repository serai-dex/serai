...
use crate::{
    ...
    ringct::{
        ...
        clsag::{ClsagDetails, ClsagInput, ClsagMultisig},
        RctPrunable,
    },
    rpc::Rpc,
    transaction::{Input, Transaction},
    wallet::{key_image_sort, uniqueness, Decoys, SignableTransaction, TransactionError},
};
...
impl PreprocessMachine for TransactionMachine {
    ...
    fn preprocess<R: RngCore + CryptoRng>(
        ...
        let mut serialized = Vec::with_capacity(
            ...
            self.clsags.len()
                * ((2 * (32 + 32)) + (2 * (32 + 32)) + ClsagMultisig::serialized_len()),
        );
        let clsags = self
            .clsags
            .drain(..)
